# Round Sync Teldrive - tgdrive/Rclone for Android!
[![license: GPL v3](https://img.shields.io/badge/License-GPLv3-blue.svg)](https://github.com/paresh996/Round-Sync-Teldrive/blob/master/LICENSE) [![Latest Downloads](https://img.shields.io/github/downloads/paresh996/Round-Sync-Teldrive/latest/total)](https://github.com/paresh996/Round-Sync-Teldrive/releases) [![GitHub release](https://img.shields.io/github/v/release/paresh996/Round-Sync-Teldrive?include_prereleases)](https://github.com/paresh996/Round-Sync-Teldrive/releases/latest)
[![Android Lint](https://github.com/paresh996/Round-Sync-Teldrive/actions/workflows/lint.yml/badge.svg)](https://github.com/paresh996/Round-Sync-Teldrive/actions/workflows/lint.yml)

A fork of Round-Sync cloud file manager, powered by tgdrive/rclone.
Visit [https://roundsync.com](https://roundsync.com) for more information on the original Round-Sync!
...
|:-----------------------------------------------------------------------------------------------------------------------------------:|:--------------------------------------------------------------------------------------------------------------------------------------------------:|:-------------------------------------------------------------------------------------------------------------------------------------:|
| <img src="https://github.com/paresh996/Round-Sync-Teldrive/blob/master/docs/cloud-computing.png?raw=true" alt="Cloud Access" width="144" />  | <img src="https://github.com/paresh996/Round-Sync-Teldrive/blob/master/docs/locked-padlock.png?raw=true" alt="256 Bit End-to-End Encryption" width="108" /> | <img src="https://github.com/paresh996/Round-Sync-Teldrive/blob/master/docs/smartphone.png?raw=true" alt="Integrated Experience" width="132"/> |
...
Grab the [latest version](https://github.com/paresh996/Round-Sync-Teldrive/releases/latest) of the signed APK and install it on your phone.
...
## Libraries
- [rclone](https://github.com/tgdrive/rclone) - Calling this a library is an understatement. Without tgdrive/rclone, there would not be Round Sync "Teldrive". See https://rclone.org/donate/ to support rclone and see Teldrive here: https://github.com/tgdrive
...
If you want to add more translations, see the original Round-Sync's [weblate-project](https://hosted.weblate.org/projects/round-sync/round-sync/)!
...
## About this app
This is a fork of [**Round-Sync**](https://github.com/newhinton/Round-Sync) which itself is a fork of [**RCX**](https://github.com/x0b/rcx) by **x0b**<sup>[x0b](https://github.com/x0b)</sup> which is itself a fork of [**rcloneExplorer**](https://github.com/patrykcoding/rcloneExplorer) by **Patryk Kaczmarkiewicz**<sup>[patrykcoding](https://github.com/patrykcoding)</sup> .
